...
public class TowerHotbarDisplay extends UIComponent {
    ...
    public void create() {
        ...
        TextureRegionDrawable cavemenVillageImage = new TextureRegionDrawable(new TextureRegion(new Texture("images/towers/cavemenvillageicon.png")));
        ...
        ImageButton cavemenVillageBtn = new ImageButton(cavemenVillageImage);
        ...
        addPlacementListener(cavemenVillageBtn, "cavemenvillage");
