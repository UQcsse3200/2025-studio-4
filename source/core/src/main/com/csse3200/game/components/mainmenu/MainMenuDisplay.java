...
public class MainMenuDisplay extends UIComponent {
  ...
  private void addActors() {
    ...
    ImageButton bookBtn = createImageButton("images/bookbutton.png", "Book");
    ImageButton storyBtn = createImageButton("images/bookbutton.png", "Story"); // Using same image for story
    ImageButton rankingBtn = createImageButton("images/ranking.png", "Ranking");
