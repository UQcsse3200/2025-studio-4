...
        table.add(displayModeSelect).left();
        ...
        table.row().padTop(20f); // Add a little space before the next section
        table.add(new Label("Audio Settings", skin, "title")).colspan(2);

        table.row().padTop(10f);
        Table musicTable = new Table();
        musicTable.add(musicVolumeSlider).width(100).left();
        musicTable.add(musicVolumeValue).left().padLeft(5f).expandX();
        ...
        soundTable.add(soundVolumeSlider).width(100).left();
        soundTable.add(soundVolumeValue).left().padLeft(5f).expandX();

        table.add(soundVolumeLabel).right().padRight(15f);
        table.add(soundTable).left();

        table.row().padTop(20f);
        table.add(new Label("Gameplay Settings", skin, "title")).colspan(2);
...
                });
        ...
        musicVolumeSlider.addListener(
                (Event event) -> {
                    ...
                    musicVolumeValue.setText(String.format("%d%%", (int)(value * 100)));
                    return true;
                });
        ...
        soundVolumeSlider.addListener(
                (Event event) -> {
                    ...
                    soundVolumeValue.setText(String.format("%d%%", (int)(value * 100)));
                    return true;
                });
