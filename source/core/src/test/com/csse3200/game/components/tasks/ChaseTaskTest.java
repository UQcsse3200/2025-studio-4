...
class ChaseTaskTest {
  ...
  void shouldMoveTowardsTarget() {
    ...
    AITaskComponent ai = new AITaskComponent().addTask(new ChaseTask(target, 10, 5, 10, new Vector2(1f, 1f)));
  ...
  void shouldChaseOnlyWhenInDistance() {
    ...
    ChaseTask chaseTask = new ChaseTask(target, 10, 5, 10, new Vector2(1f,1f));
